...
<body>
    <div class="vh-100 d-flex justify-content-center align-items-center ">
        <div class="col-md-5 p-5 shadow-sm border rounded-5 border-primary bg-white">
            <h2 class="text-center mb-4 text-primary">Daxil Ol</h2>
            <form method="post" action="loginwork.php">
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Email Ünvanınız</label>
                    <input type="name" name="name" class="form-control border border-primary" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Email Ünvanınız</label>
                    <input type="surname" name="surname" class="form-control border border-primary" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Email Ünvanınız</label>
            ...
            <div class="mt-3">
                <p class="mb-0  text-center">Qeydiyyatdan Keçməmisiniz? <a href="../register/register.php"
                        class="text-primary fw-bold">Qeydiyyatdan Keç</a></p>
            </div>
        </div>
    </div>
</body>
